...
uses
  ...
  ZAbstractConnection, ZConnection, ADODB, RpCon, RpDefine, RpRave, RpConDS;
...
type
  Tdm = class(TDataModule)
    ...
    dsPremios: TDataSource;
    carregarPremios: TZQuery;
    rViewPrint: TRvProject;
    rvMilhar: TRvDataSetConnection;
    rvCabecaloPremio: TRvProject;
    rvCabecalo: TRvDataSetConnection;
