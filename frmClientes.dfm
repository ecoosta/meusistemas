object fClientes: TfClientes
  ...
  object btnSalvaCliente: TButton
    Left = 806
    Top = 558
    Width = 131
    Height = 35
  ...
  object gClientes: TDBGrid
    ...
    Columns = <
      ...
      item
        Alignment = taCenter
        Expanded = False
        FieldName = 'TOTAL_MILHAR'
        Title.Alignment = taCenter
        Title.Caption = 'T Milhar'
        Width = 85
        Visible = True
      end>
  end
